...
function App() {
  ...
  const apiKey = ''; // ⚠️ Paste your OMDB API key here
  ...
  return (
    <>
      {apiKey === '' && (
        <h1>
          Please visit this website and create your API key, then paste it in <code>App.js</code>:
          <br />
      ...
      <Container>
        ...
        <Modal show={showModal} onHide={handleClose}>
          ...
          <Modal.Body>{error?.message || 'Something went wrong.'}</Modal.Body>
          <Modal.Footer>
